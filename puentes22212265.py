...
print(f"El valor de resistencia del resistor Re es de {Re} Ohms.\ n")
...
# Raíces del denominadorrr
raices_den = np.roots(den)

print("Numerador:", num)
print("Denominador:", den)
print("Raíces del denominador:", raices_den)
...
plt.plot(t,pidu1,':',linewidth = 4, color = clr6,label = 'PID(t)') #Respuesta en lazo abierto
...
plt.plot(t,pidu2,':',linewidth = 4, color = clr6,label = 'PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize = 11)
plt.ylabel('Vi(t)[V]',fontsize = 11)
...
plt.plot(t,pidu3,':',linewidth = 4, color = clr6,label = 'PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
plt.ylim(0,1.1); plt.yticks(np.arange(0,1.2,0.1))
plt.xlabel('t[s]',fontsize = 11)
plt.ylabel('Vi(t)[V]',fontsize = 11)
...
plt.plot(t,pidu4,':',linewidth = 4, color = clr6,label = 'PID(t)') #Respuesta en lazo abierto
plt.xlim(0,10); plt.xticks(np.arange(0,11,1))
